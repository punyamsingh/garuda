// attendance/getWorkingHoursByModeForMonth.js
...
export default async function handler(req,res) {
    if (req.method === 'GET') {
        const { employee_id,monthStart,mode } = req.query;
        ...
        // Calculate working hours similar to daily and weekly calculations
        let workingHours = 0;
